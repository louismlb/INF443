...
mesh mesh_primitive_ellipsoid(float a=1.f, float b=1.f, float c=1.f, const vec3& p0={0,0,0}, size_t Nu=20, size_t Nv=40);
...
mesh mesh_primitive_filled_cone(float radius=0.2f, const vec3& p_base={0,0,0}, const vec3& p_extremity={0,0,1}, size_t Nu=20, size_t Nv=10);
